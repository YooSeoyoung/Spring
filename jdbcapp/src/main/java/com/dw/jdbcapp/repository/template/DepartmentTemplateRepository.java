...
public class DepartmentTemplateRepository implements DepartmentRepository {
    ...
    public Department saveDepartment(Department department) {
        String query = "insert into 부서 values(?, ?)";
        jdbcTemplate.update(query,department.getDepartmentId(),department.getDepartmentName());
        return department;
    }
    ...
    public Department updateDepartment(Department department) {
        ...
        jdbcTemplate.update(query,department.getDepartmentName(),department.getDepartmentId());
        return department;
    }
